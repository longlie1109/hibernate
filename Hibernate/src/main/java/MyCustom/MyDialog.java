...
public class MyDialog extends JDialog {
    ...
    public MyDialog(String content, int type) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
    ...
    final ImageIcon iconError = new ImageIcon("src/main/resources/imageicons8_cancel_70px.png");
    final ImageIcon iconSuccess = new ImageIcon("src/main/resources/imageicons8_checkmark_70px.png");
    final ImageIcon iconInfo = new ImageIcon("src/main/resources/imageicons8_info_70px.png");
    final ImageIcon iconWarning = new ImageIcon("src/main/resources/imageicons8_warning_shield_70px.png");
    ...
    private void addControls() {
        ...
        lblClose = new JLabel(new ImageIcon("src/main/resources/imageicons8_x_24px.png"));
