...
public class LoaiBUS {
    ...
    public boolean themLoai(int maLoai, String tenLoai) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
    ...
    public boolean xoaLoai(String ma) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        if (ma.trim().equals("")) {
            new MyDialog("Chưa ch�?n loại để xoá!", MyDialog.SUCCESS_DIALOG);
            return false;
        }
    ...
    public boolean suaLoai(String ma, String ten) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        if (ten.trim().equals("")) {
            new MyDialog("Không được để trống tên loại!", MyDialog.ERROR_DIALOG);
            return false;
        }
