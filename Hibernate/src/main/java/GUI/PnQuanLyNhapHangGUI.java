...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private void customControls() {
        ...
        dtmGioNhap.addColumn("�?ơn giá");
        dtmGioNhap.addColumn("Thành ti�?n");
        ...
        dtmPhieuNhap.addColumn("Tổng ti�?n");
        ...
        dtmCTPhieuNhap.addColumn("�?ơn giá");
        dtmCTPhieuNhap.addColumn("Thành ti�?n");
    ...
    private void initComponents() {
        ...
        tblGioNhap.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Tên SP", "Số lượng", "�?ơn giá", "Thành ti�?n"
            }
        ));
        ...
        btnThemVaoGio.setText("Ch�?n nhập");
        ...
        txtTongTienPN.setBorder(javax.swing.BorderFactory.createTitledBorder("Tổng ti�?n"));
        ...
        txtDenNgay.setBorder(javax.swing.BorderFactory.createTitledBorder("�?ến ngày"));
        ...
        tblCTPhieuNhap.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Số lượng", "�?ơn giá", "Thành ti�?n"
            }
        ));
        ...
        txtCTDonGia.setBorder(javax.swing.BorderFactory.createTitledBorder("�?ơn giá"));
        ...
        txtCTThanhTien.setBorder(javax.swing.BorderFactory.createTitledBorder("Thành ti�?n"));
    ...
    private void btnThemVaoGioActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnThemVaoGioActionPerformed
        ...
        if (row > -1) {
            ...
            new MyDialog("Chưa ch�?n sản phẩm để nhập!", MyDialog.ERROR_DIALOG);
        }
