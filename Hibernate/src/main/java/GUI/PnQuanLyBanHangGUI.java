...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    private void addControlsBanHang() {
        ...
        dtmSanPhamBan.addColumn("�?ơn giá");
        dtmSanPhamBan.addColumn("Còn lại");
        dtmSanPhamBan.addColumn("�?ơn vị tính");
        ...
        JLabel lblTitleGioHang = new JLabel("Gi�? hàng");
        ...
        dtmGioHang.addColumn("�?ơn giá");
        dtmGioHang.addColumn("Thành ti�?n");
        ...
        JLabel lblDonGia = new JLabel("�?ơn giá");
        ...
        btnThemVaoGio = new JLabel("Thêm vào gi�?");
        ...
        lblTongTien = new JLabel("Tổng ti�?n");
        ...
        JLabel lblTitleHoaDon = new JLabel("THÔNG TIN HO�? �?ƠN");
        ...
        lblDonGiaCT = new JLabel("�?ơn giá");
        lblThanhTienCT = new JLabel("Thành ti�?n");
        ...
        JLabel lblTitleCTHD = new JLabel("CHI TIẾT HO�? �?ƠN");
        ...
        dtmCTHoaDon.addColumn("�?ơn giá");
        dtmCTHoaDon.addColumn("Thành ti�?n");
    ...
    private void loadDataComboboxLoaiBanSP() {
        ...
        cmbLoaiSPBanHang.addItem("0 - Ch�?n loại");
